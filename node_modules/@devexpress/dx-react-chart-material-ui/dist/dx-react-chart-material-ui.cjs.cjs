...
var index_js = require('@mui/material/node/styles/index.js');
var classNames = _interopDefault(require('clsx'));
var List = _interopDefault(require('@mui/material/node/List/index.js'));
var ListItemText = _interopDefault(require('@mui/material/node/ListItemText/index.js'));
var ListItem = _interopDefault(require('@mui/material/node/ListItem/index.js'));
var Typography = _interopDefault(require('@mui/material/node/Typography/index.js'));
var Popper = _interopDefault(require('@mui/material/node/Popper/index.js'));
var dxChartCore = require('@devexpress/dx-chart-core');
var Paper = _interopDefault(require('@mui/material/node/Paper/index.js'));
...
var getBorderColor = function getBorderColor(theme) {
  return theme.palette.mode === 'light' ? index_js.lighten(index_js.alpha(theme.palette.divider, 1), 0.88) : index_js.darken(index_js.alpha(theme.palette.divider, 1), 0.68);
};
var PREFIX = 'Target';
var classes = {
...
var withClassName = function withClassName() {
  ...
  return function (Target) {
    return index_js.styled(dxReactChart.withPatchedProps(setClassName)(Target)).apply(void 0, args);
  };
};
...
var Point = index_js.styled(dxReactChart.withPatchedProps(setClassName)(dxReactChart.ScatterSeries.Point))(function (_ref) {
  var theme = _ref.theme;
...
var StyledPopper = index_js.styled(Popper)(function () {
...
var Root$3 = index_js.styled('div')(function (_ref) {
  var _ref2;
